    ...
    <div className="w-full px-5 flex flex-col justify-between">
      <div className="flex flex-col mt-5">
        {messages.map((message) =>
          message.senderId.id == user?.id ? (
            <div className="flex justify-end mb-4" key={message.content}>
            ...
            <div className="flex justify-start mb-4" key={null}>
              <Avatar src={null} size={50} />
      ...
      <div className="py-5 flex flex-row ">
        <input
          ...
          onChange={(value) => {
            setMessageInput(value.target.value);
        ...
        />
        <button
          className="w-20 bg-gray-300 py-5 px-3 rounded-xl"
