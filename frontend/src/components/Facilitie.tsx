...
export const facilities = [
  ...
  },
  {
    ...
    icon: FaParking,
    description:
      'Guests can park their vehicles for free on the premises of this property.',
  },
  {
    label: 'Paid Parking on Premises',
    icon: MdLocalParking,
    description:
      'Paid parking options are available on the premises of this property.',
  },
  {
    label: 'Air Conditioning',
    icon: MdAcUnit,
    description:
      'This property is equipped with air conditioning for guest comfort.',
  },
  {
    label: 'Dedicated Workspace',
    icon: MdWork,
    description:
      'This property provides a dedicated workspace or office area for guests to work in.',
  },
  {
    label: 'Swimming Pool',
    icon: FaSwimmingPool,
